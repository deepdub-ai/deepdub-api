...
audio = client.tts(
    ...
    model="dd-etts-3.3", locale="en-US",
)
```
...
The agent will use the correct endpoints, default model (`dd-etts-3.3`), proper authentication headers, and real voice preset IDs from the skill.
