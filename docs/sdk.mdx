...
<ParamField body="model" type="string" default="dd-etts-3.2">
  Model ID. Available models: `dd-etts-3.2` (current), `dd-etts-3.0`, `dd-etts-2.5` (legacy).
</ParamField>
...
|----------|-------------|
| `dd-etts-3.2` | Current default — best quality, recommended for all new integrations |
| `dd-etts-3.0` | Stable |
