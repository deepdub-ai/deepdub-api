...
await deepdub.generateToFile("./meditation.wav",
  ...
  { locale: "en-US", voicePromptId: "c0866c1c-0731-45b2-9c90-21be974513b4", model: "dd-etts-3.3" }
);
```
</Tab>
</Tabs>
...
await deepdub.generateToFile("./news_hindi.wav",
  ...
  { locale: "hi-IN", voicePromptId: "731912b7-7e63-4de9-acf6-b16c4bdb0c9e_prompt-V2-Newscaster-Headlines", model: "dd-etts-3.3" }
);
```
</Tab>
</Tabs>
...
await deepdub.generateToFile("./storyteller_es.wav",
  ...
  { locale: "es-ES", voicePromptId: "4202cbc4-5862-4af5-83f4-286ef487d593_reading-neutral", model: "dd-etts-3.3" }
);
```
</Tab>
</Tabs>
...
await deepdub.generateToFile("./promo_de.wav",
  ...
  { locale: "de-DE", voicePromptId: "24c20fcb-b04c-46fc-82d6-0eabac3cc563_prompt-V2-Commercial-Soft-Sell", model: "dd-etts-3.3" }
);
```
</Tab>
</Tabs>
...
await deepdub.generateToFile("./sports_hi.wav",
  ...
  { locale: "hi-IN", voicePromptId: "4b51aefb-4d72-4e2f-8a41-6d546b23eba1_sports-commentator-high-energy", model: "dd-etts-3.3" }
);
```
</Tab>
</Tabs>
