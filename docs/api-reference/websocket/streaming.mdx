---
title: Streaming In and Streaming Out API
description: "Stream text in as it is produced and stream the generated audio back, over one persistent WebSocket session"
---
