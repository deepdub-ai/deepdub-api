...
<ParamField body="model" type="string" default="dd-etts-3.3">
  Model ID. Available: `dd-etts-3.3` (current), `dd-etts-3.0`, `dd-etts-2.5` (legacy).
</ParamField>
...
<ParamField body="targetDuration" type="number">
  ...
  <Warning>
    `targetDuration` is no longer actively maintained. Use a slow or fast variant `voicePromptId` for the relevant speaker instead. Existing integrations will continue to work.
  </Warning>
</ParamField>
