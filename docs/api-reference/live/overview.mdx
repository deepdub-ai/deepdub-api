...
| Region | URL |
|--------|-----|
| US (default) | `https://restapi.deepdub.ai/live` |
| EU | `https://restapi.eu.deepdub.ai/live` |

Use the host for the region your account is provisioned in. The examples below use the US host; substitute the EU one throughout, including the captions WebSocket.
...
- The API is regional — see [Base URL](#base-url). Your API key works only against the region your account is provisioned in.
